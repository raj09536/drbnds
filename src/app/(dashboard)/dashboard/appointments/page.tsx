...
const CONSULTATION_ICONS: Record<string, string> = {
    "in-clinic": "🏥",
    phone: "📞",
    video: "📹",
}
...
export default function AppointmentsPage() {
    ...
    const todayCount = appointments.filter(a => new Date(a.created_at).toDateString() === today).length
                ...
                <main className="p-6">
                    ...
                    <div className="flex flex-col gap-4">
                        {filtered.map(appt => {
                            ...
                            const icon = CONSULTATION_ICONS[appt.consultation_type] || "💬"
                                        ...
                                        <div className="flex flex-wrap items-start justify-between gap-4">
                                            ...
                                            <div className="flex items-center gap-2 shrink-0">
                                                <select
                                                    ...
                                                    className="text-xs font-semibold rounded-lg px-3 py-2 border border-black/10 cursor-pointer focus:outline-none"
